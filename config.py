class Config:
    def __init__(self):
        ...
        self.activation = "gelu"  # Тип активации

        # Параметры архитектуры
        self.attention_type = "scaled_dot_product"  # "scaled_dot_product", "multi_head", "additive"
        self.normalization_type = "layer_norm"  # "layer_norm", "batch_norm", "none"
        self.layer_type = "transformer"  # "transformer", "feed_forward", "convolutional"
    ...
    def validate(self):
        ...
        assert self.attention_type in ["scaled_dot_product", "multi_head", "additive"], "Недопустимый тип внимания"
        assert self.normalization_type in ["layer_norm", "batch_norm", "none"], "Недопустимый тип нормализации"
        assert self.layer_type in ["transformer", "feed_forward", "convolutional"], "Недопустимый тип слоя"